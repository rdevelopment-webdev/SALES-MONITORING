<template>
            ...
            <table class="w-full border-collapse text-left">
              ...
              <tbody class="divide-y divide-gray-100">
                ...
                >
                  ...
                  <td v-if="canEdit" class="px-4 py-1.5 whitespace-nowrap">
      ...
      >
        ...
        >
          <div class="flex items-center gap-1.5 text-[12px] text-gray-400">
            ...
            <span
              >Restoring moves the user back to the active user list and
              restores their system access.</span
            >
          </div>
          <button
            @click="showArchiveModal = false"
  ...
  <template v-else>
    <div
      class="flex items-center justify-center h-screen bg-[#f4f6fa] font-['Overpass'] text-[13px] text-gray-400"
    >
      {{
        permissionsLoading
...
// --- PERMISSIONS ---
// Effective canView / canEdit / canAdd for the logged-in user on this page.
const {
